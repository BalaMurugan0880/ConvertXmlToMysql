...
$xml = simplexml_load_file("goodnewspost.xml") or die("Error: Cannot create object");
...
foreach ($xml->xpath('//item') as $item) {
    ...
    //  $sqlupdatepost =  "UPDATE tbl_tutorials SET thumbnail='".$thumbnail."' WHERE id='".$post_id."'";
    ...
    foreach ($result_assoc as $user_id) {
        ...
        $sql = "INSERT INTO posts(id,mainModule_id,title,slug,link,pubDate,user_id,content,post_type,is_published,category) VALUES ('" . $post_id . "','" . $mainModule_id . "','" . $title . "','" . $slug . "','" . $link . "','" . $pubDate . "','" . $user_id . "','" . $content . "','" . $post_type . "','" . $is_published1 . "','" . $category_name . "')"; 

        // $sql2 = "INSERT INTO category_tbl(mainmodule_id,category_name,category_slug,is_published,user_id) VALUES ('" . $mainModule_id ."','" . $category_name ."','" . $category_name ."','" . $is_published1 ."','" . $user_id ."')";

        // $sqlgetcategoryid =  "SELECT id FROM category_tbl WHERE category_name = '".$category_name."'";
